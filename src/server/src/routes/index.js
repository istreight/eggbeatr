...
module.exports = (app) => {
    ...
    app.get("/api", (_req, res) => res.status(200).send({
        routes: {
            ...
            , description: {
                ...
                , "/api/instructors": "The list of instructors and related information, including preferences and pri" +
                    "vates."
    ...
    // Preferences (single)
    app.get(
        "/api/preferences/:preferenceId"
        , InstructorPreferencesController.retrieve
    );
    app.put(
        "/api/preferences/:preferenceId"
        , InstructorPreferencesController.update
    );
    app.delete(
        "/api/preferences/:preferenceId"
        , InstructorPreferencesController.destroy
    );

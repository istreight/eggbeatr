...
class ToggleTable extends React.Component {
    ...
    getBodyRows() {
        ...
        return data.map((dataRow, index) => React.createElement(
            RemoveRow, {
    ...
    styleCell(cell, index) {
        ...
        duplicateInstructors = instructorNames.filter(
            (instructor) => !uniqueInstructors.has(instructor)
        );
    ...
    render() {
        return ( <
            ...
            AddRow callback = {
                (ref) => this.setComponentReference("addRow", ref)
            }
            componentType = {
            ...
            index = {
                this.state.dataBody.length
            }
            styleCell = {
                this.styleCell.bind(this)
            }
            styleRow = {
                this.styleRow.bind(this)
            }
            /> <
            /tbody> <
            /table>

...
class Connector extends React.Component {
    ...
    getGridData(populate) {
        ...
        if (populate === "default") {
            ...
            returnValue = fetch(
                this.props.serverURI + "/api/grid?headerId=" + this
                .state.headerId
            ).then((res) => res.json()).then((json) => this.formatGridRes(
                json)).catch(
                (error) => {
                    console.error(error);
                    return defaultRes;
    ...
    setGridData(payload) {
        ...
        headers.append("Content-Type", "application/json");
        return fetch(
            this.props.serverURI + "/api/grid?headerId=" + this.state
            .headerId, {
                headers: headers
                , method: "POST"
                , body: JSON.stringify(payload)
    ...
    updateGridData(gridId, payload) {
        ...
        headers.append("Content-Type", "application/json");
        return fetch(
            this.props.serverURI + "/api/grid/" + gridId +
    ...
    deleteGridData(gridId) {
        ...
        ).then((res) => res.json()).catch((error) => console.error(
            error));
    }
    ...
    getHeaderData(populate) {
        ...
        if (populate === "default") {
            ...
            returnValue = fetch(this.props.serverURI + "/api/headers").then(
                (res) => res.json()
            ).then((json) => this.formatHeaderRes(json)).catch((
                error) => {
                console.error(error);
                return defaultRes;
            });
    ...
    setHeaderData(payload) {
        ...
        return fetch(this.props.serverURI + "/api/headers", {
            ...
            , method: "POST"
            , body: JSON.stringify(payload)
        }).then((res) => res.json()).then((json) => this.formatHeaderRes(
            [json])).catch(
            (error) => console.error(error)
        );
    }
    deleteHeaderData(headerId) {
        return fetch(
            this.props.serverURI + "/api/headers/" + headerId, {
                method: "DELETE"
            }
        ).then((res) => res.json()).catch((error) => console.error(
            error));
    ...
    getInstructorData(populate) {
        ...
        if (populate === "default") {
            ...
            returnValue = fetch(
                this.props.serverURI + "/api/instructors?headerId=" +
                this.state.headerId
            ).then((res) => res.json()).then((json) => this.formatInstructorRes(
                json)).catch(
                (error) => {
                    console.error(error);
                    return defaultRes;
    ...
    updateInstructorData(instructorId, payload) {
        ...
        headers.append("Content-Type", "application/json");
        return fetch(
            this.props.serverURI + "/api/instructors/" +
            instructorId + "?headerId=" +
            this.state.headerId, {
                headers: headers
                , method: "PUT"
                , body: JSON.stringify(payload)
    ...
    getLessonData(populate) {
        ...
        if (populate === "default") {
            ...
            returnValue = fetch(
                this.props.serverURI + "/api/lessons?headerId=" +
                this.state.headerId
            ).then((res) => res.json()).then((json) => this.formatLessonsRes(
                json)).catch(
                (error) => {
                    console.error(error);
                    return defaultRes;
    ...
    setLessonData(payload) {
        ...
        headers.append("Content-Type", "application/json");
        return fetch(
            this.props.serverURI + "/api/lessons?headerId=" + this.state
            .headerId, {
                headers: headers
                , method: "POST"
                , body: JSON.stringify(payload)
    ...
    updateLessonData(lessonId, payload) {
        ...
        headers.append("Content-Type", "application/json");
        return fetch(
            this.props.serverURI + "/api/lessons/" + lessonId +
            "?headerId=" + this.state.headerId, {
                headers: headers
                , method: "PUT"
                , body: JSON.stringify(payload)
    ...
    getPreferenceData(populate) {
        var returnValue;
        var defaultRes = JSON.parse(JSON.stringify(DefaultData.InstructorPreferences));
        for (let i = 0; i < defaultRes.length; i++) {
            Object.assign(defaultRes[i], {
                id: i + 1
            });
        ...
        if (populate === "default") {
            ...
            returnValue = fetch(
                this.props.serverURI + "/api/preferences?headerId=" +
                this.state.headerId
            ).then((res) => res.json()).then((json) => this.formatPreferenceRes(
                json)).catch(
                (error) => {
                    console.error(error);
                    return defaultRes;
    ...
    updatePreferenceData(preferenceId, payload) {
        ...
        headers.append("Content-Type", "application/json");
        return fetch(
            this.props.serverURI + "/api/preferences/" +
            preferenceId + "?headerId=" +
            this.state.headerId, {
                headers: headers
                , method: "PUT"
                , body: JSON.stringify(payload)
    ...
    formatPreferenceRes(preferenceRes) {
        ...
        return fetch(
            ...
            preferenceRes.forEach((preference) => {
                ...
                newInstructorObject = instructors.find(
                    (instructor) => {
                ...
                // This covers the case where the preference ID is -1, for uninstantiated
    ...
    getPrivatesData(populate) {
        ...
        if (populate === "default") {
            ...
            returnValue = fetch(
                this.props.serverURI + "/api/privates?headerId=" +
                this.state.headerId
            ).then((res) => res.json()).then((json) => this.formatPrivatesRes(
                json)).catch(
                (error) => {
                    console.error(error);
                    return defaultRes;
    ...
    setPrivatesData(payload) {
        ...
        headers.append("Content-Type", "application/json");
        return fetch(
            this.props.serverURI + "/api/privates?headerId=" + this
            .state.headerId, {
                headers: headers
                , method: "POST"
                , body: JSON.stringify(payload)
    ...
    updatePrivatesData(privatesId, payload) {
        ...
        headers.append("Content-Type", "application/json");
        return fetch(
            this.props.serverURI + "/api/privates/" + privatesId +
            "?headerId=" + this.state.headerId, {
                headers: headers
                , method: "PUT"
                , body: JSON.stringify(payload)
    ...
    formatPrivatesRes(privatesRes) {
        return fetch(
            ...
            privatesRes.forEach((privateLesson) => {
                ...
                var newInstructorObject = instructors.find(
                    (instructor) => {
                        return instructor.id ===
                            newInstructorId;
                    });

...
class About extends React.Component {
    ...
    render() {
        return ( <
            div >
            <
            h2 className = "content-head is-center" > About < /h2> <
            div className = "content-section-description" >
            eggbeatr <
            div className = "content-section-explanation" >
            an application designed to build a calendar of swim lessons using customizable sets of
                ...
                [{
                    data: [React.createElement(
                        FeatureDescription, {
                            ...
                            , textDesc: "Schedule private lessons at a specific time and we'll make sure nothing confli" +
                                "cts."
                        })]
                    , styleClass: ""
                }, {
                    ...
                    data: [React.createElement(
                        FeatureDescription, {
                            ...
                            , key: "key-featuredescription-0"
                            , textDesc: "eggbeatr makes the most of your instructors by using their time between lesson" +
                                "s."
                        })]
                    , styleClass: ""
                }]

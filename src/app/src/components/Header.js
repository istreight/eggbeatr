...
class Header extends React.Component {
    ...
    edit() {
        ...
        var reCellStyles = new RegExp(/(\serror-cell)|(\swarning-cell)/
            , "g");
    ...
    addSet() {
        ...
        this.props.createComponent(body, "Header").then((res) => {
    ...
    removeSet(setTitle) {
        ...
        id = deletedSet.id;
        this.props.removeComponent(id, "Header").then(() => {
            var newSets = sets.filter((set) => set !==
                deletedSet);
    ...
    fitSetList(setName) {
        ...
        Animator.slide(800, (progress) => {
            setList.scrollTo(
                initial + progress * (maxWidth - viewWidth +
                    16 * (setName.length + 1))
                , 0
            );
        });
    ...
    render() {
        return ( <
            ...
            <
            ScrollingAnchor data = {
                this.state.data.versionName
            }
            styleClass = {
                "pure-menu-heading"
            }
            ...
            <
            SetList callback = {
                (ref) => this.setComponentReference("setList", ref)
            }
            data = {
                this.state.data
            }
            ...
            data = {
                [React.createElement(Input, {
                    callback: (ref) => this.setComponentReference(
                        "setInputField", ref)
                    , handleBlur: this.disableEditButton.bind(
                        this)

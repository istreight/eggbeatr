...
class Instructors extends React.Component {
    ...
    getComponentQuantity() {
        ...
        validInstructors = instructorsArray.filter((instructorName) => {
            ...
            return !privatesOnly && Date.now() < Date.parse(
                expiryTime);
        });
    ...
    editInstructors() {
        ...
        this.editButton.setState({
            data: "Finish Editing"
            , handleClick: this.finishEditingInstructors.bind(
                this)
    ...
    addInstructor(instructorBody) {
        // Add to database.
        return this.props.createComponent(instructorBody, "Instructor")
            .then((res) => {
                this.sortInstructors(Object.assign(this.state.data
                    , res.data));
                return res;
            });
    }
            ...
            if (instructor.id === instructorId) {
                this.props.removeComponent(instructorId, "Instructor").then(
                    () => {
                        ...
                        this.setState({
                            data: instructors
                        }, () => this.instructorTable.toggleState(
                            true));
                    });
    ...
    sizeTable() {
        ...
        var dynamicInstructors = document.getElementById(
            "dynamicInstructors");
    ...
    getTableHeader() {
        return [
            ["Instructor", "Date of Hire", "WSI Expiration"
                , "Privates Only", "Preferences"
            ]
        ];
    }
    /**
    ...
    privatesOnlyHandler(id, checked) {
        ...
        this.setState(this.state, () => {
            this.props.callback(this.state, "instructors", true);
            this.props.setChecklistQuantity("instructors", this
                .getComponentQuantity());
        });
    }
    /**
    ...
    render() {
        return ( <
            ...
            anchorHandleClick = {
                this.editInstructors.bind(this)
            }
            buttonText = {
                "Edit Instructors"
            }
            ...
            /> <
            InstructorTable addCallback = {
                this.addInstructor.bind(this)
            }
            callback = {
            ...
            preferenceHandler = {
                this.preferenceHandler.bind(this)
            }
            privatesOnlyHandler = {
                this.privatesOnlyHandler.bind(this)
            }
            removeCallback = {
                this.removeInstructor.bind(this)
            }
            updateCallback = {
                this.updateInstructor.bind(this)
            }
            /> <
            ...
            data = {
                "List the instructors teaching in this lesson set. Once added, their individual" +

...
class Lessons extends React.Component {
    ...
    storeLessonValues() {
        var finalPromise;
        var data = this.state.data;
        var savedNotification = ReactDOM.findDOMNode(this).querySelector(
        ...
        var missingId = Object.keys(data).filter(
    ...
    render() {
        return ( <
            div >
            <
            h2 className = "content-head is-right" > Lessons < /h2> <
            ...
            anchorCallback = {
                (ref) => this.setComponentReference("saveButton"
                    , ref)
            }
            anchorHandleClick = {
                this.storeLessonValues.bind(this)
            }
            buttonText = {
                "Save Lessons"
            }
            ...
            /> <
            Table callback = {
                (ref) => this.setComponentReference("lessonTable"
                    , ref)
            }
            dataBody = {
                [
                        ...
                        [
                            ...
                            , React.createElement(Input, {
                                callback: (ref) => this.setComponentReference(
                                    "lessonInputs"
                                    , this.lessonInputs.concat(
                                        ref)
                                )
                                , handleBlur: this.storeLessonValues
                                    .bind(this)
            ...
            Tutorial buttonClass = {
                "pure-button content-next-button"
            }
            data = {
                "Input the quantity of each lesson type, using digits from 1 to 9."
            }
            headingClass = {
                "content-head"
            }
